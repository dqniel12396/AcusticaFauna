...
Camino recomendado para la mayoria de usuarios: PowerShell + HTTPS + Python 3.11.
...
Python recomendado: 3.11.x. Python 3.13 puede fallar con dependencias ML. En AcusticaFauna, paquetes como `torch`, `opensoundscape`, `librosa`, `numba`, `llvmlite` y `soundfile` son mas estables con Python 3.11.

### A. Instalar Python 3.11

1. Abre https://www.python.org/downloads/release/python-3110/
2. Descarga `Windows installer (64-bit)`.
3. Durante la instalacion marca `Add python.exe to PATH`.
4. Abre una terminal PowerShell nueva y verifica:
